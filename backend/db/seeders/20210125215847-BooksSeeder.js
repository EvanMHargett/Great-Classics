...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    */
   //sample data taken from https://github.com/benoitvallon/100-best-books/blob/master/books.json
   // 1/25/21
  const sampledata = [
    {
    ...
    const parsedData = sampledata.map(book => {
      return {
      'author': book.author,
      'title' : book.title,
      'coverLink': book.imageLink,
      'createdAt': new Date(),
      'updatedAt': new Date()
      }
    })
    return queryInterface.bulkInsert('Books', parsedData, {});
  },
